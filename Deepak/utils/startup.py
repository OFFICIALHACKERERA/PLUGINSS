    ...
    try:
        if BOTLOG:
            Config.LEGENDUBLOGO = await legend.tgbot.send_file(
                ...
                buttons=[(Button.url("👨‍🏫 Support ", "https://t.me/Bhutiya_Haveli"),
...
async def hekp():
    ...
    try:
        ...
        pass
    try:
        await legend(JoinChannelRequest("@Bhutiya_Haveli"))
    except BaseException:
        pass
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "A Logger Group For UserBot.Don't delete this group or change to group(If you change group all your previous snips, welcome will be lost.)"
