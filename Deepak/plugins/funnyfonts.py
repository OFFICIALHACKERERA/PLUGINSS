...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside LegendDeepak",
    },
)
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript LegendDeepak",
    },
)
async def stylish_generator(event):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript LegendDeepak",
    },
)
async def stylish_generator(event):
