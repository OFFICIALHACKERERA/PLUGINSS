...
@VcPlayer.on(events.NewMessage(pattern=r"^[?!]purge"))
@is_admin
...
@VcPlayer.on(events.NewMessage(pattern="^[!?/]spurge"))
@is_admin
...
@VcPlayer.on(events.NewMessage(pattern="^[!?/]del$"))
@is_admin
...
@VcPlayer.on(events.callbackquery.CallbackQuery(data="purges"))
async def _(event):
